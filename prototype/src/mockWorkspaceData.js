export const requisitions = [
  { code: "REQ-2026-041", role: "Auxiliar de Serviços Gerais", post: "Leblon Power", requester: "Marcos Lima", openings: 4, created: "14/09/2026", status: "Aguardando diretoria", tone: "warning" },
  { code: "REQ-2026-040", role: "Porteiro", post: "Bay View Botafogo", requester: "Ana Souza", openings: 2, created: "13/09/2026", status: "Ajustes solicitados", tone: "danger" },
  { code: "REQ-2026-039", role: "Jovem Aprendiz Administrativo", post: "Sede Alpha & Omega", requester: "Carlos Nunes", openings: 1, created: "12/09/2026", status: "Aprovada", tone: "success" },
...
export const homeActions = [
  ...
  { title: "Analisar requisição pendente", detail: "Auxiliar de Serviços Gerais · Leblon Power", owner: "Diretoria", due: "Pendente", route: "approvals" },
...
export const recentActivity = [
  ...
  { title: "Requisição enviada para aprovação", detail: "REQ-2026-041 · Leblon Power", time: "Hoje, 09:18", tone: "info" },
